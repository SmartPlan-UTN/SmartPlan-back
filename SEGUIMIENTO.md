...
| Módulo de autenticación JWT | `En progreso` | `SMART-14-autenticacion-control-acceso` | — | CU1–CU4 implementados; 183 unitarios y 38 e2e en verde; falta abrir PR y confirmar el contrato frontend |
...
|---|---|---|---|---|---|
| CU1 | Iniciar sesión | `usuario`, `sesion_usuario` | `En progreso` | `SMART-14-autenticacion-control-acceso` | |
| CU2 | Registrar usuario | `usuario`, `estado_usuario` | `En progreso` | `SMART-14-autenticacion-control-acceso` | |
| CU3 | Recuperar contraseña | `usuario` | `En progreso` | `SMART-14-autenticacion-control-acceso` | |
| CU4 | Cerrar sesión | `sesion_usuario` | `En progreso` | `SMART-14-autenticacion-control-acceso` | |
