...
export class EsquemaInicial1786560621317 implements MigrationInterface {
  name = 'EsquemaInicial1786560621317';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_6d2f2cd3ddfab61cd330f1a890" ON "estado_usuario" ("key") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_9dab8b145701f68e39c88133de" ON "actividad_favorito" ("id_lista_favorito", "id_actividad") `,
    );
    await queryRunner.query(
      `CREATE TABLE "detalle_plan" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "id_plan" integer NOT NULL, "id_actividad" integer NOT NULL, "orden" smallint NOT NULL, "costo_estimado" numeric(10,2) NOT NULL DEFAULT '0', "duracion_estimada" integer NOT NULL DEFAULT '0', "observacion" text, CONSTRAINT "PK_47adc266c7ed420c00331e50248" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_dd25123bdedc668a662f76fb40" ON "detalle_plan" ("id_actividad") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_435a39364823e198e6988effbb" ON "detalle_plan" ("id_plan", "orden") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_e879162df254e6f938ad470f89" ON "pais" ("nombre") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_051a4baf95dfb69d3f3d90d04a" ON "ciudad" ("id_pais", "nombre") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_5b08b1b3de216473d838009000" ON "departamento" ("id_ciudad", "nombre") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_4c0910cbb32c7b62b7ad6730dc" ON "actividad_lugar" ("id_actividad", "id_lugar") `,
    );
    await queryRunner.query(
      `CREATE TABLE "actividad" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "nombre" character varying(150) NOT NULL, "descripcion" text NOT NULL, "costo_estimado" numeric(10,2) NOT NULL, "duracion_estimada" integer NOT NULL, CONSTRAINT "PK_ae34007f8c81abaf44d8992662d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_5ebda4671370b8f3453ac416a4" ON "actividad_categoria" ("id_actividad", "id_categoria") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_e8ddf670966b656f20d22f24de" ON "estado_solicitud" ("key") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_6f90866de93e2ecb9136d9c1f7" ON "tipo_salida" ("key") `,
    );
    await queryRunner.query(
      `CREATE TABLE "solicitud_plan" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "id_usuario" integer NOT NULL, "presupuesto" numeric(10,2) NOT NULL, "fecha_solicitud" TIMESTAMP WITH TIME ZONE NOT NULL, "id_tipo_salida" integer NOT NULL, "id_estado_solicitud" integer NOT NULL, "observaciones" text, CONSTRAINT "PK_a8a37801bd041d88c6313efe0a6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_85399d80a6c1828d1c87e8db72" ON "solicitud_plan_categoria" ("id_solicitud_plan", "id_categoria") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_1a3a74f3d3335abca014e553a0" ON "estado_categoria" ("key") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_6771d90221138c5bf48044fd73" ON "categoria" ("nombre") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_1bd8d03a840994db3da2846b4e" ON "preferencia_usuario" ("id_usuario", "id_categoria") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_a0840f2e5f809aca7e9d0e4908" ON "permiso" ("key") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_e4b93a459f7547fb440e3325f8" ON "rol_permiso" ("id_rol", "id_permiso") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_c5bf682cf2cee2f563b3335f11" ON "rol" ("key") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_2863682842e688ca198eb25c12" ON "usuario" ("email") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_5a832cc77082dff4c28faba69a" ON "lista_favorito" ("id_usuario") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_26d245e6f8ff582f27d36de075" ON "plan_favorito" ("id_lista_favorito", "id_plan") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_ed46a4c033e179d7be668b3903" ON "estado_plan" ("key") `,
    );
    await queryRunner.query(
      `CREATE TABLE "plan" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "titulo" character varying(150) NOT NULL, "descripcion" text, "id_solicitud_plan" integer, "id_estado_plan" integer NOT NULL, "costo_total_estimado" numeric(10,2) NOT NULL DEFAULT '0', "duracion_total_estimada" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_54a2b686aed3b637654bf7ddbb3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "valoracion" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "puntaje" smallint NOT NULL, "id_plan" integer NOT NULL, "id_retroalimentacion" integer, CONSTRAINT "PK_f600c62375f0641fa63a03b6114" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_39ae25d3df40fc03b3d350d058" ON "valoracion" ("id_plan") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_3a6126aff629a4e63bd7aadcf6" ON "proveedor_externo" ("key") `,
    );
    await queryRunner.query(
      `CREATE TABLE "sincronizacion_externa" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "id_proveedor_externo" integer NOT NULL, "entidad" character varying(60) NOT NULL, "estado" character varying(30) NOT NULL, "fecha_inicio" TIMESTAMP WITH TIME ZONE NOT NULL, "fecha_fin" TIMESTAMP WITH TIME ZONE, "cantidad_registros" integer NOT NULL DEFAULT '0', "mensaje_error" text, CONSTRAINT "PK_90d1af6f73a862eb2d06a5f0c47" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_ef77b3eef2ab3ce4c29f891f1c" ON "parametro_sistema" ("nombre") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "valoracion" ADD CONSTRAINT "FK_39ae25d3df40fc03b3d350d058a" FOREIGN KEY ("id_plan") REFERENCES "plan"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "valoracion" DROP CONSTRAINT "FK_39ae25d3df40fc03b3d350d058a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_39ae25d3df40fc03b3d350d058"`,
    );
